...
class MovieRentalA {
    public static void main(String[] args) {
        ...
        MovieRentalA movieRental = new MovieRentalA();
    ...
    public String statement() {
        ...
        double totalAmount =
                rentals.stream().mapToDouble(this::computeRentalAmount).sum();
        ...
        int frequentRenterPoints =
                rentals.stream().mapToInt(this::getFrequentRenterPoints).sum();
        ...
        statement +=
                rentals.stream()
                        .map(rental -> computeStatementLine(rental))
